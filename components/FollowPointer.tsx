...
const FollowPointer = ({x, y, info} : {
  ...
  return (
    <>
        <m.div className="h-4 w-4 rounded-full absolute z-50"
            style={{
                top: y,
                left: x,
                pointerEvents: "none",
            ...
            exit={{
                ...
                <svg 
                    ...
                    >
                    <path d="M14.082 2.182a.5.5 0 0 1 .103.557L8.528 15.467.a.5.5 0 0 1-.917-.007L5.57 10.694.803 8.652a.5.5 0 0 1-.006-.916l12.728-5.657a.5.5 0 0 1 .556.103z" ></path>
                </svg>
                <m.div
                    style={{
